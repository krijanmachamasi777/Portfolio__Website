...
const Hero = () => {
  return (
    <div id="home" className='hero'>
      ...
      <h1><span>I'm Krijan Machamasi ,</span> Full - Stack  developer based in Nepal.</h1>
      <p>I am a Full - Stack developer from Bhakapur,Nepal with 1 years of experience.</p>
