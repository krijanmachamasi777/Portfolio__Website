...
const Hero = () => {
  return (
    <div id="home" className='hero'>
      ...
      <h1><span>I'm Krijan Machamasi ,</span> Frontend React  developer based in Nepal.</h1>
      <p>I am a Frontend React developer from Bhaktapur,Nepal with 1 years of experience.</p>
